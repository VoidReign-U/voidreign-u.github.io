...
[https://github.com/m1k1o/blog/blob/master/config.ini](https://github.com/m1k1o/blog/blob/master/config.ini)
...
it's look like it's social media website try to exploit post by upload reverse shell * seccess *

i take the profile_big.jpg from profile page for the account i already have and put php code in it
...
**_ try find : found cowsay file with perm to write on them it's not usefull now _**
...
-rw-rw-rw- 1 root root 1302 Aug 14 1999 /usr/share/cowsay/cows/turkey.cow
  ...
  try to search in /var/www/html/blog/ maybe like config.ini in github  -->  i found password for baca
...
**_ now the time to exploit cowsay : _**

** i search on google and i found i can type perl command in file for cowasy _ another success _ **
